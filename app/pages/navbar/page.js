...
//         <img className="w-9 h-9 mr-2 rounded-full" src="https://upload.wikimedia.org/wikipedia/en/3/35/Snapdeal_Logo_new.png" alt="logo" />
//         <span className="font-semibold text-2xl tracking-tight">Snapdeal</span>
//       </div>
...
//           <input className="p-2 rounded-l lg:w-[500px] w-full lg:mt-0 mt-4 tracking-wider" type="search" name="search" id="search" placeholder="Search products & brands" />
//           <button className="bg-black lg:p-2 rounded-r text-white w-24 lg:mt-0 h-10 mt-4">Search</button>
//         </div>
//         <div className="flex lg:mx-4 mt-4 lg:mt-0 ">
...
//           </p>
//         </div>
//         <div className="flex text-white mt-4 lg:mt-0">
//           <p className="lg:mx-4">Sign In</p>
//           <p>
